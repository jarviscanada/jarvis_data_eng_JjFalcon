...
/**
 * This program solves some common math problems and provides static methods for
 * public consumption.
 */
public class MathChallenge {
	 ...
	 *
	 * Bitwise XOR operator compares bits of two operands and returns false or 0 if
	 * they are equal and returns true or 1 if they are not equal.
	 *
	...
	/**
	 * Count the number of prime numbers up to the given input number using Sieve of
	 ...
	 * Missing Number = Sum of the first n natural numbers less Sum of the elements
	 * in the given array 
	 * Time Complexity: O(n)
	 *
	 * @param numArray to determine which number is missing in the series of natural
	 *                 numbers
	...
	/**
	 * Find the missing number is an array of sequential numbers using the Gauss
	 * formula Gauss Formula: n*(n+1)/2 Missing Number = Sum of the first n natural
	 * numbers less Sum of the elements in the given array 
	 * Time Complexity: O(n)
	 *
	 * @param numArray to determine which number is missing in the series of natural
	 *                 numbers
	...
	/**
	 * Find the missing number is an array of sequential numbers using sets Time
	 * Complexity: O(n)
	 *
	 * @param numArray to determine which number is missing in the series of natural
	 *                 numbers
	...
	/**
	 * Find the fibonacci number of a given "n" using recursion Time Complexity:
	 * O(2^n)
	 *
	...
	/**
	 * Find the fibonacci number of a given "n" using dynamic programming Time
	 * Complexity: O(n)
	 *
	 * @param n          to determine the fibo number at that position
	 * @param fibResults to hold the already calculated fibo number of the nth
	 *                   position
	 * @return the nth fibo number
	 */
	...
	public static void main(String[] args) {
		...
		do {
			...
			int[] testArray = new int[] { 3, 1, 2, 6, 4, 5, 7, 9 };
			
			switch (option) {
			case 1:	
				System.out.println(isEven(input) ? "Number " + input + " is Even" : "Number " + input + " is Odd");
				break;
			case 2:
				System.out.println(isOdd(input) ? "Number " + input + " is Even" : "Number " + input + " is Odd");
				break;
			case 3:
				swapNumbersXOR(input, getInput(scanner));
				break;
			case 4:
				swapNumbersArithmetic(input, getInput(scanner));
				break;
			case 5:
				int numOfPrime = countPrime(input);
			    System.out.println("There are " + numOfPrime + " prime numbers in " + input);
				break;
			case 6:
				System.out.println("This is the test array using manual summation: ");
				System.out.println(Arrays.toString(testArray));
			    int missingNum = findMissingNumberSum(testArray);
			    System.out.println("The missing number in the array is: " + missingNum);
				break;
			case 7:
				System.out.println("This is the test array using Gaus Formula: ");
				System.out.println(Arrays.toString(testArray));
			    int missingNum1 = findMissingNumberGauss(testArray);
			...
			case 8:
				...
				System.out.println(Arrays.toString(testArray));
			    int missingNum2 = findMissingNumberHashSet(testArray);
