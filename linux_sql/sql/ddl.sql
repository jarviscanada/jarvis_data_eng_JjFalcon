...
VALUES
	(DEFAULT, 'node1A.jrvs.ca', 1, 'x86_64', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 256, 750000, '2019-05-29 15:00:00.000'),
	(DEFAULT, 'node1B.jrvs.ca', 2, 'x86_64', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 512, 600000, '2019-05-29 15:01:00.000'),
	(DEFAULT, 'node1C.jrvs.ca', 1, 'x86_128', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 256, 900000, '2019-05-29 15:02:00.000'),
	(DEFAULT, 'node1D.jrvs.ca', 2, 'x86_64', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 512, 900000, '2019-05-29 15:04:00.000'),
	(DEFAULT, 'node1E.jrvs.ca', 2, 'x86_128', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 512, 500000, '2019-05-29 15:10:00.000'),
	(DEFAULT, 'node2A.jrvs.ca', 1, 'x86_64', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 256, 300000, '2019-05-29 15:11:00.000'),
	(DEFAULT, 'node2B.jrvs.ca', 2, 'x86_64', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 512, 600000, '2019-05-29 15:12:00.000'),
	(DEFAULT, 'node2C.jrvs.ca', 1, 'x86_128', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 256, 500000, '2019-05-29 15:13:00.000'),
	(DEFAULT, 'node2D.jrvs.ca', 2, 'x86_64', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 512, 900000, '2019-05-29 15:14:00.000'),
	(DEFAULT, 'node2E.jrvs.ca', 2, 'x86_128', 'Intel(R) Xeon(R) CPU @ 2.30GHz', 2300.000, 512, 500000, '2019-05-29 15:20:00.000');
