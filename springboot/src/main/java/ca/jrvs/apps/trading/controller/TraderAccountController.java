...
public class TraderAccountController {
  ...
  @ApiOperation(value = "Delete a trader", notes = "Delete a trader IFF its account amount is 0 and no open positions.  Also delete teh associated account and securityOrders.")
